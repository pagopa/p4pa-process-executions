...
public class ExportFileEntityExtendedController implements
  ...
  public ResponseEntity<Integer> updateExportFileStatus(Long ingestionFlowFileId, ExportFileStatus oldStatus, ExportFileStatus newStatus,
                        String filePath, String fileName, Long numTotalRows, String errorDescription) {
    int result = repository.updateStatus(ingestionFlowFileId, oldStatus, newStatus, filePath, fileName, numTotalRows, errorDescription);
    if(result>0){
